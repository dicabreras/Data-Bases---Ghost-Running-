...
-- Note: schema includes `tra_Name` and `tra_Image`, so we populate them (NULL when not available)
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user1@ghost.com', @r1, '2025-10-20 06:00:00','00:45:00','Morning run - park loop',5.50,12.00,9.00,420.00,45.0,'run1.jpg','Running',0,80.0); SET @t1 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user2@ghost.com', @r2, '2025-10-21 07:30:00','01:10:00','Long cycle route',5.90,15.00,11.00,650.00,120.0,'cycle2.jpg','Cycling',1,NULL); SET @t2 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user3@ghost.com', @r3, '2025-10-18 18:15:00','00:30:00','Tempo intervals',6.00,11.50,10.50,300.00,20.0,'run3.jpg','Running',0,78.0); SET @t3 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user4@ghost.com', @r4, '2025-10-19 05:50:00','00:52:00','Early hill repeats',5.20,13.00,10.00,480.00,60.0,'run4.jpg','Running',0,82.0); SET @t4 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user5@ghost.com', @r5, '2025-10-20 09:10:00','00:55:00','City ride',5.60,14.00,10.50,510.00,90.0,NULL,'Cycling',0,NULL); SET @t5 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user6@ghost.com', @r6, '2025-10-17 06:40:00','00:38:00','Park sprint set',5.40,12.50,9.50,390.00,40.0,'run6.jpg','Running',0,79.0); SET @t6 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user7@ghost.com', @r7, '2025-10-16 07:00:00','01:30:00','Endurance ride',6.10,18.00,12.00,900.00,200.0,NULL,'Cycling',1,NULL); SET @t7 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user8@ghost.com', @r8, '2025-10-15 06:15:00','00:35:00','Short morning run',5.30,11.80,9.20,360.00,30.0,'run8.jpg','Running',0,81.0); SET @t8 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user9@ghost.com', @r9, '2025-10-14 18:05:00','00:50:00','Evening tempo',5.70,13.50,10.80,500.00,70.0,NULL,'Running',0,77.0); SET @t9 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user10@ghost.com', @r10, '2025-10-13 07:20:00','00:27:00','Track short run',5.10,10.50,9.50,250.00,15.0,'run10.jpg','Running',0,83.0); SET @t10 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user11@ghost.com', @r11, '2025-10-12 06:45:00','01:05:00','Hill climb session',5.95,16.00,12.50,700.00,140.0,'cycle11.jpg','Cycling',1,NULL); SET @t11 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user12@ghost.com', @r12, '2025-10-11 06:00:00','00:46:00','Recovery run',5.65,12.30,9.80,430.00,50.0,'run12.jpg','Running',0,79.0); SET @t12 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user13@ghost.com', @r13, '2025-10-10 05:50:00','02:10:00','Century ride',6.30,20.00,14.00,1200.00,300.0,'cycle13.jpg','Cycling',1,NULL); SET @t13 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user14@ghost.com', @r14, '2025-10-09 06:30:00','00:33:00','Park tempo',5.25,11.20,9.70,310.00,35.0,NULL,'Running',0,80.0); SET @t14 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user15@ghost.com', @r15, '2025-10-08 07:10:00','01:05:00','City commute ride',5.85,15.50,12.00,680.00,130.0,'cycle15.jpg','Cycling',0,NULL); SET @t15 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user16@ghost.com', @r16, '2025-10-07 05:55:00','00:28:00','Fast 5k',5.45,11.00,9.20,270.00,18.0,'run16.jpg','Running',0,82.0); SET @t16 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user17@ghost.com', @r17, '2025-10-06 06:10:00','00:59:00','Evening hill run',5.60,13.00,10.40,460.00,65.0,NULL,'Running',0,78.0); SET @t17 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user18@ghost.com', @r18, '2025-10-05 06:00:00','00:48:00','Lake loop',5.70,13.20,10.60,490.00,72.0,'run18.jpg','Running',0,79.0); SET @t18 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user19@ghost.com', @r19, '2025-10-04 07:40:00','00:42:00','Sunrise run',5.35,11.90,9.90,340.00,28.0,NULL,'Running',0,81.0); SET @t19 = LAST_INSERT_ID();
INSERT INTO Training (user_Email, rou_Id, tra_Datetime, tra_Duration, tra_Name, tra_Rithm, tra_MaxSpeed, tra_AvgSpeed, tra_Calories, tra_ElevationGain, tra_Image, tra_TrainingType, tra_IsGhost, tra_AvgStride)
VALUES
('user20@ghost.com', @r20, '2025-10-03 06:05:00','00:34:00','Short recovery',5.15,10.80,9.40,280.00,22.0,'run20.jpg','Running',0,84.0); SET @t20 = LAST_INSERT_ID();
...
-- (rest identical to Delivery 2)

-- Comments insert (same as Delivery 2)
